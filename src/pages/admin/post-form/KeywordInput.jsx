        ...
        <div className="mt-2">
            <div className="flex flex-wrap gap-2 mb-2">
                {keywords.map(keyword => (
                    <span key={keyword} className="flex items-center bg-blue-500/20 text-blue-300 text-sm font-medium px-2.5 py-1 rounded-full">
                        {keyword}
                        <button type="button" onClick={() => removeKeyword(keyword)} className="ml-2 text-blue-300 hover:text-white">
                            <X size={14} />
                        </button>
                    </span>
                ))}
