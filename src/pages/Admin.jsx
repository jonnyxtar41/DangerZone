...
import { Home, PlusSquare, Edit, BarChart, Users, Palette, Shield, Settings, FileText, DollarSign, MessageSquare, Folder, FileImage, Menu, X, LogOut, UserCog, Database } from 'lucide-react';
...
const Admin = ({ onContentUpdate }) => {
    ...
    const fetchData = useCallback(async () => {
        ...
        const [postsData, categoriesData, sectionsData, subcategoriesData] = await Promise.all([
            getPosts({ includeDrafts: true, includePending: true }),
            getCategories(),
            getSections(),
            getSubcategories()
        ]);
